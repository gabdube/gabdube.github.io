...
export class MsdfFont {
    ...
    constructor(texture_id: number, atlas_data: ArrayBuffer) {
...
export class EngineAssets {
    ...
    fonts: Map<string, MsdfFont> = new Map();
    ...
    private async load_msdf_font(texture_id: number, name: string, image_path: string, atlas_data_path: string): Promise<boolean> {
