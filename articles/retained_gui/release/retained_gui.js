...
export class GameClient {
     ...
     * @param {string} buffer
     */
    push_chars_buffer(buffer) {
        const ptr0 = passStringToWasm0(buffer, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.gameclient_push_chars_buffer(this.__wbg_ptr, ptr0, len0);
    }
    /**
     * @param {number} scroll_y
     */
    update_scroll_value(scroll_y) {
        wasm.gameclient_update_scroll_value(this.__wbg_ptr, scroll_y);
    }
    /**
     * @param {number} button
     * @param {boolean} pressed
...
function __wbg_get_imports() {
    const imports = {};
    imports.wbg = {};
    imports.wbg.__wbg_log_d09d9d8cfda9b91e = function(arg0, arg1) {
        let deferred0_0;
        let deferred0_1;
        try {
            deferred0_0 = arg0;
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('retained_gui_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
